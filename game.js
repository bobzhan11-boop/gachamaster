...
const ITEMS = {
  starter: [
    ...
    { id: "s_07", name: "Sticker", emoji: "🏷️", rarity: "C", desc: "A shiny star sticker" },
  ...
  anime: [
    ...
    { id: "an_04", name: "Bento Box", emoji: "🍱", rarity: "C", desc: "Ninja fuel" },
  ...
  magic: [
    ...
    { id: "mk_04", name: "Poison Apple", emoji: "☠️", rarity: "C", desc: "Don't eat this one!" },
